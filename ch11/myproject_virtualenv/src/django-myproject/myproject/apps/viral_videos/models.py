...
from myproject.apps.core.models import CreationModificationDateBase, UrlBase, CreatorMixin


class ViralVideo(CreationModificationDateBase, UrlBase, CreatorMixin):
    ...
    def get_url_path(self):
        ...
        return reverse("viral_videos:viral-video-detail",
