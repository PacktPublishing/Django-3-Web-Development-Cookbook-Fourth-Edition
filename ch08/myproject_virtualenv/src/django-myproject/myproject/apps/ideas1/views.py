...
def add_or_change_idea(request, pk=None):
    ...
    return render(request, "ideas1/idea_form.html", context)
...
def delete_idea(request, pk):
    ...
    if request.method == "POST":
        idea.delete()
        return redirect("ideas1:idea_list")
    context = {"idea": idea}
    return render(request, "ideas1/idea_deleting_confirmation.html", context)
...
def idea_list(request):
    ...
    return render(request, "ideas1/idea_list.html", context)
...
class IdeaListView(View):
    ...
    template_name = "ideas1/idea_list.html"
